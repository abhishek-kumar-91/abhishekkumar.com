...
import { FaLinkedinIn,  FaRegFilePdf, FaGithub, FaTwitter, FaArrowDown } from "react-icons/fa";
      ...
      <div className="pt-20">
        <a href="#projects" className="scroll-link">
            <div className="bg-white px-4 py-2 rounded-full">
                <h5 className="flex items-center text-sm gap-2"><FaArrowDown /> Scroll Down</h5>
            </div>
            </a> 
