    ...
    <footer className="bg-black py-8 text-white">
      <div className="max-w-7xl mx-auto px-6 flex flex-col items-center space-y-4 text-center">
        ...
        <p className="text-sm text-gray-400">
          Passionate Frontend Developer. Focused on clean design, smooth UX &
          real-world problem solving.
        </p>

        <div className="flex space-x-6 text-xl mt-2">
          <a
            href="https://github.com/abhishek-kumar-91"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/abhishekkumardev91/"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            href="mailto:abhishekkumar958830@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
          >
